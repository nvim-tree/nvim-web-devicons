return {
  ...
  ["frag"]           = { icon = "", color = "#7B3DB9", cterm_color = "91",  name = "FragmentShader"             },
  ...
  ["geom"]           = { icon = "󰕣", color = "#7B3DB9", cterm_color = "91",  name = "GeometryShader"             },
  ...
  ["glsl"]           = { icon = "󰛡", color = "#7B3DB9", cterm_color = "91",  name = "OpenGLShadingLanguage"      },
  ...
  ["vert"]           = { icon = "", color = "#7B3DB9", cterm_color = "91",  name = "VertexShader"               },
