return {
  ...
  ["adb"]           = { icon = "󰬈", color = "#599EFF", cterm_color = "111", name = "AdaBody"                    },
  ["ads"]           = { icon = "󰯫", color = "#A074C4", cterm_color = "140", name = "AdaSpecification"           },
  ...
  ["gpr"]           = { icon = "󰯽", color = "#6D8086", cterm_color = "66",  name = "GPRBuildProject"            },
