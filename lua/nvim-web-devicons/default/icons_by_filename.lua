return {
  ...
  ["go.mod"]                     = { icon = "", color = "#00ADD8", cterm_color = "74",  name = "GoMod"                   },
  ["go.sum"]                     = { icon = "", color = "#00ADD8", cterm_color = "74",  name = "GoSum"                   },
  ["go.work"]                    = { icon = "", color = "#00ADD8", cterm_color = "74",  name = "GoWork"                  },
