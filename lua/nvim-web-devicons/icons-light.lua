local icons_by_filename = {
  ...
  ["go.mod"]                     = { icon = "", color = "#36677C", cterm_color = "24",  name = "GoMod"                   },
  ["go.sum"]                     = { icon = "", color = "#36677C", cterm_color = "24",  name = "GoSum"                   },
  ["go.work"]                    = { icon = "", color = "#36677C", cterm_color = "24",  name = "GoWork"                  },
...
local icons_by_file_extension = {
  ...
  ["adb"]           = { icon = "", color = "#118080", cterm_color = "30",  name = "AdaBody"                    },
  ["ads"]           = { icon = "", color = "#333333", cterm_color = "236", name = "AdaSpecification"           },
  ...
  ["gpr"]           = { icon = "", color = "#AA22AA", cterm_color = "127", name = "GPRBuildProject"            },
