return { -- this file is generated from lua/nvim-web-devicons/default/icons_by_file_extension.lua, please do not edit
  ...
  ["frag"]           = { icon = "", color = "#5C2E8B", cterm_color = "54",  name = "FragmentShader"             },
  ...
  ["geom"]           = { icon = "󰕣", color = "#5C2E8B", cterm_color = "54",  name = "GeometryShader"             },
  ...
  ["glsl"]           = { icon = "󰛡", color = "#5C2E8B", cterm_color = "54",  name = "OpenGLShadingLanguage"      },
  ...
  ["vert"]           = { icon = "", color = "#5C2E8B", cterm_color = "54",  name = "VertexShader"               },
